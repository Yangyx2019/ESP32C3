...
// #define BLUFI_DEVICE_NAME            "ESP32C3"
                                ...
                                int32_t event_id, void* event_data)
{
    ...
    BLUFI_INFO("DDDDDDDDDDDDDDDDDD%d\n",local_ip.ip);
    BLUFI_INFO( "self_ip:"IPSTR"\n",IP2STR(&local_ip.ip));
    BLUFI_INFO( "self_netmask:"IPSTR"\n",IP2STR(&local_ip.netmask));
    BLUFI_INFO( "self_gw:"IPSTR"\n",IP2STR(&local_ip.gw));
...
//自此ip_addr数组的数据是“192.168.43.71”
        ...
        info.sta_ssid = ip_addr;
        info.sta_ssid_len = 16;//ipv4的ip地址最多16个字节
